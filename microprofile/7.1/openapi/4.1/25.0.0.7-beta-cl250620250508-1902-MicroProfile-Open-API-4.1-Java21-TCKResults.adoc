...
+
https://repo1.maven.org/maven2/org/eclipse/microprofile/open-api/microprofile-open-api-tck/4.1/microprofile-open-api-tck-4.1.jar[MicroProfile Open API 4.1 TCK]
+
