...
== Open Liberty 25.0.0.7-beta - MicroProfile Open API 4.1 Certification Summary (Java 21)
...
+
xref:25.0.0.7-beta-MicroProfile-Open-API-4.1-Java21-TCKResults.adoc[TCK results summary]
