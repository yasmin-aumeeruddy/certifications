...
== Open Liberty 25.0.0.7-beta - MicroProfile Health 4.0.1 Certification Summary (Java 21)
...
+
xref:25.0.0.7-beta-MicroProfile-Health-4.0.1-Java21-TCKResults.adoc[TCK results summary]
