...
== Open Liberty 25.0.0.7-beta - MicroProfile Health 4.0.1 Certification Summary (Java 17)
...
+
xref:25.0.0.7-beta-MicroProfile-Health-4.0.1-Java17-TCKResults.adoc[TCK results summary]
