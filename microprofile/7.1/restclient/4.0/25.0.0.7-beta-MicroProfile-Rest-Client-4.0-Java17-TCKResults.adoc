...
== Open Liberty 25.0.0.7-beta - MicroProfile Rest Client 4.0 Certification Summary (Java 17)
...
+
xref:25.0.0.7-beta-MicroProfile-Rest-Client-4.0-Java17-TCKResults.adoc[TCK results summary]
