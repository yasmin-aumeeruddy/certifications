...
== Open Liberty 25.0.0.7-beta-cl250620250508-1902 - MicroProfile Rest Client 4.0 Certification Summary (Java 21)
...
+
xref:25.0.0.7-beta-cl250620250508-1902-MicroProfile-Rest-Client-4.0-Java21-TCKResults.adoc[TCK results summary]
